                ...
                <div class="card-content p-6">
                    <form action="{{ route('mode-of-recruitment.update', $modeOfRecruitment->PromotionID) }}" method="POST">
                        ...
                        <div>
                            ...
                            <select id="employee_id" name="employee_id" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 border" required>
                                ...
                                @foreach($employees as $emp)
                                    <option value="{{ $emp->id }}" data-emp_code="{{ $emp->empCode }}" {{ old('employee_id', $modeOfRecruitment->employee_id) == $emp->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="text" name="emp_code" id="emp_code" value="{{ old('emp_code', $modeOfRecruitment->employee->empCode) }}"
