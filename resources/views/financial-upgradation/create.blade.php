...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-foreground">Add Financial Upgradation Record</h1>
            <p class="text-muted-foreground">Create a new financial upgradation record</p>
        </div>
    ...
    <div class="card border rounded-xl">
        ...
        <div class="card-content p-4">
            <form action="{{ route('financial-upgradation.store') }}" method="POST">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="existing_designation" id="existing_designation" class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400" required>
                                ...
                                @foreach(App\Models\FinancialUpgradation::DESIGNATIONS as $key => $value)
                                    <option value="{{ $value }}" {{ old('existing_designation') == $value ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select name="upgraded_designation" id="upgraded_designation" class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400" required>
                                <option value="">Select Designation</option>
                                @foreach(App\Models\FinancialUpgradation::DESIGNATIONS as $key => $value)
                                    <option value="{{ $value }}" {{ old('upgraded_designation') == $value ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select name="financial_upgradation_type" id="financial_upgradation_type" class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400" required>
                                ...
                                <option value="MACP" {{ old('financial_upgradation_type') == 'MACP' ? 'selected' : '' }}>MACP</option>
                                <option value="PROMOTION" {{ old('financial_upgradation_type') == 'PROMOTION' ? 'selected' : '' }}>Promotion</option>
                                <option value="ACP" {{ old('financial_upgradation_type') == 'ACP' ? 'selected' : '' }}>ACP</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" name="no_of_financial_upgradation" id="no_of_financial_upgradation" value="{{ old('no_of_financial_upgradation', 1) }}"
                                   class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"
                                   required>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="promotion_date" id="promotion_date" value="{{ old('promotion_date') }}"
                                   class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"
                                   required>
                        ...
                        <div>
                            ...
                            <input type="date" name="date_in_grade" id="date_in_grade" value="{{ old('date_in_grade') }}"
                                   class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"
                                   required>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="existing_scale" id="existing_scale" value="{{ old('existing_scale') }}"
                                   class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"
                        ...
                        <div>
                            ...
                            <input type="text" name="upgraded_scale" id="upgraded_scale" value="{{ old('upgraded_scale') }}"
                                   class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="pay_fixed" id="pay_fixed" class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400" required>
                                ...
                                <option value="YES" {{ old('pay_fixed') == 'YES' ? 'selected' : '' }}>YES</option>
                                <option value="NO" {{ old('pay_fixed') == 'NO' ? 'selected' : '' }}>NO</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="existing_pay" id="existing_pay" value="{{ old('existing_pay') }}"
                                   class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"
                                   required>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="existing_grade_pay" id="existing_grade_pay" value="{{ old('existing_grade_pay') }}"
                                   class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"
                                   required>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="upgraded_pay" id="upgraded_pay" value="{{ old('upgraded_pay') }}"
                                   class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"
                                   required>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="upgraded_grade_pay" id="upgraded_grade_pay" value="{{ old('upgraded_grade_pay') }}"
                                   class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"
                                   required>
                        ...
                        <div>
                            ...
                            <textarea name="macp_remarks" id="macp_remarks" rows="3"
                                      class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">{{ old('macp_remarks') }}</textarea>
