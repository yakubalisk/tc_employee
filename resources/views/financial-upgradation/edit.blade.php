                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="employee_id" name="employee_id" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 border" required>
                                ...
                                @foreach($employees as $emp)
                                    <option value="{{ $emp->id }}" data-emp_code="{{ $emp->empCode }}" {{ old('employee_id', $financialUpgradation->employee_id) == $emp->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="text" name="emp_code" id="emp_code" value="{{ old('emp_code', $financialUpgradation->employee->empCode) }}"
