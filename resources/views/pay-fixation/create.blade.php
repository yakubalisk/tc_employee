    ...
    <div class="max-w-7xl mx-auto">
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Add Pay Fixation Record</h1>
                    <p class="text-gray-600">Create a new pay fixation record</p>
                </div>
            ...
            <div class="card border rounded-xl">
                <div class="card-content p-6">
                    <form action="{{ route('pay-fixation.store') }}" method="POST">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="pay_fixation_date" id="pay_fixation_date" value="{{ old('pay_fixation_date') }}"
                                           class="py-2 px-3 block w-full border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500"
                                           required>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" step="0.01" name="basic_pay" id="basic_pay" value="{{ old('basic_pay') }}"
                                           class="py-2 px-3 block w-full border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500"
                                ...
                                <div>
                                    ...
                                    <input type="number" step="0.01" name="grade_pay" id="grade_pay" value="{{ old('grade_pay') }}"
                                           class="py-2 px-3 block w-full border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500"
                                           placeholder="0.00">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="cell_no" id="cell_no" value="{{ old('cell_no') }}"
                                           class="py-2 px-3 block w-full border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500"
                                           min="1" required>
                                ...
                                <div>
                                    ...
                                    <select name="revised_level" id="revised_level" 
                                        ...
                                        @foreach(App\Models\PayFixation::REVISED_LEVELS as $key => $value)
                                            <option value="{{ $key }}" {{ old('revised_level') == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="level_2" id="level_2" 
                                        ...
                                        @foreach(App\Models\PayFixation::LEVEL_2_OPTIONS as $key => $value)
                                            <option value="{{ $key }}" {{ old('level_2') == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="pay_fixation_remarks" id="pay_fixation_remarks" rows="3"
                                      class="py-2 px-3 block w-full border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500">{{ old('pay_fixation_remarks') }}</textarea>
