    ...
    <div class="max-w-7xl mx-auto">
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Add Transfer Record</h1>
                    <p class="text-gray-600">Create a new employee transfer record</p>
                </div>
                    ...
                    <form action="{{ route('transfer.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="date_of_releiving" id="date_of_releiving" value="{{ old('date_of_releiving') }}"
                                           class="py-2 px-3 block w-full border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500"
                                           required>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="transfer_order_no" id="transfer_order_no" value="{{ old('transfer_order_no') }}"
                                           class="py-2 px-3 block w-full border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500"
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select name="transferred_region_id" id="transferred_region_id" 
                                        ...
                                        <option value="">Select Region</option>
                                        @foreach($regions as $id => $name)
                                            <option value="{{ $id }}" {{ old('transferred_region_id') == $id ? 'selected' : '' }}>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="department_worked_id" id="department_worked_id" 
                                        ...
                                        @foreach($departments as $id => $name)
                                            <option value="{{ $id }}" {{ old('department_worked_id') == $id ? 'selected' : '' }}>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="transfer_remarks" id="transfer_remarks" rows="3"
                                      class="py-2 px-3 block w-full border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Any additional remarks about the transfer">{{ old('transfer_remarks') }}</textarea>
