    ...
    <div class="max-w-7xl mx-auto">
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Add Doctor Record</h1>
                    <p class="text-gray-600">Create a new doctor record for an employee</p>
                </div>
                    ...
                    <form action="{{ route('doctor.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name_of_doctor" id="name_of_doctor" value="{{ old('name_of_doctor') }}"
                                           class="py-2 px-3 block w-full border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500"
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="address" id="address" rows="4"
                                              class="py-2 px-3 block w-full border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500"
                                              placeholder="Enter complete address of the doctor">{{ old('address') }}</textarea>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="ama_remarks" id="ama_remarks" rows="3"
                                      class="py-2 px-3 block w-full border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Any AMA related remarks">{{ old('ama_remarks') }}</textarea>
